  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-200 space-y-2">
        <Button
          variant="ghost"
          className="w-full justify-start gap-3 h-10 font-medium text-gray-700 hover:bg-gray-100"
        >
        ...
        <Button
          variant="ghost"
          className="w-full justify-start gap-3 h-10 font-medium text-red-600 hover:bg-red-50"
