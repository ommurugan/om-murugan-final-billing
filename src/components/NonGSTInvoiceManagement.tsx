...
import { Plus, Search, Filter, Printer, Mail, Eye, Edit, Trash2, Receipt, Clock, CheckCircle, AlertCircle, X } from "lucide-react";
  ...
  return <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        {invoice.status === 'overdue' && <span className="text-red-500 ml-2">
      ...
      <div className="md:hidden">
        ...
        {filteredInvoices.length === 0 ? <Card>
            ...
            {filteredInvoices.map(invoice => <MobileInvoiceCard key={invoice.id} invoice={invoice} customerName={getCustomerName(invoice.customerId)} vehicleInfo={getVehicleInfo(invoice.vehicleId)} onEdit={handleEditInvoice} onDelete={handleDeleteInvoice} onPrint={handlePrintInvoice} onEmail={handleEmailInvoice} />)}
          </div>}
      </div>
    </div>;
};
